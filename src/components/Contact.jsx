...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: FaPhone,
      title: 'Phone',
      details: ['+918708275671', 'Available: Mon-Sat, 8 AM - 2 PM'],
      color: 'text-green-600',
      bgColor: 'bg-green-100',
      link: 'tel:+918708275671',
    },
    {
      icon: FaEnvelope,
      title: 'Email',
      details: ['skpsudairamsar@gmail.com'],
      color: 'text-blue-600',
      bgColor: 'bg-blue-100',
      link: 'mailto:skpsudairamsar@gmail.com',
    },
    {
      icon: FaMapMarkerAlt,
      title: 'Main Campus',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Failed to send message. Please try WhatsApp option or call us directly at +918708275671');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white text-center shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a href="tel:+918708275671" className="flex items-center space-x-2 bg-white text-blue-600 px-6 py-3 rounded-full font-semibold hover:shadow-lg transition-all">
              <FaPhone />
              <span>Call: +918708275671</span>
            </a>
            <a
              href="https://wa.me/918708275671?text=Hello!%20I%20want%20to%20visit%20Shree%20Krishna%20Public%20School"
              target="_blank"
              rel="noopener noreferrer"
