    ...
    <section className="py-12 md:py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          {/* Little Krishna Public School */}
          <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-8 text-center hover:shadow-xl transition-all transform hover:scale-105">
            <div className="bg-white rounded-xl p-4 inline-block mb-4 shadow-md">
              <img 
                src="/images/little-krishna-logo.png" 
                alt="Little Krishna Public School Logo"
                className="w-32 h-32 object-contain mx-auto"
              />
            </div>
            <h4 className="text-xl font-bold text-gray-800 mb-2">
              Little Krishna Public School (LKPS)
            </h4>
